    ...
    <section id="skills" className="relative py-24 px-6 bg-card/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* 3D orb */}
          <Reveal animation="zoom-in" className="relative h-[420px] md:h-[500px] order-2 lg:order-1">
          ...
          <div className="space-y-5 order-1 lg:order-2">
            {skillGroups.map((g, i) => (
              <Reveal
                ...
                delay={i * 120}
              >
                <div className="bg-card rounded-2xl p-5 border border-white/5 hover:border-primary/30 transition-colors">
                  <h3
